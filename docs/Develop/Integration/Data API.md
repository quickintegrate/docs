...
4. If DDL schema is not already uploaded. <a href="/Define/model-design" target="_blank"> Please refer the link for instructions on uploading DDL schema</a>
...
7. After service creation you will be redirected to **Integration / Studio** page and you will have access to a comprehensive list of all the end-to-end services outlined in the data API.
