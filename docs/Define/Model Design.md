...
9. After service creation you will be redirected to **Integration / Studio** page and you will have access to a comprehensive list of all the end-to-end services outlined in the model design.
