...
export const sample: Template = {
  ...
  services: [
    ...
    {
      serviceName: "storedProcedureHappyPath",
      description:
        "Rest service to call stored procedure in db. db step call with valid procedure name and its input parameter. Output is the result of all the statements in the stored procedure.",
      output: JSON.stringify(
        {
          Result_1: [
            {
      ...
      endpointInfo: {
        basepath: "storedProcedureHappyPath/100",
      },
    },
    {
      serviceName: "storedProcedureUnHappyPath",
      description:
        "Rest service to call stored procedure in db. db step call with invalid procedure name. Throws exception that no such procedure name.",
      output: JSON.stringify(
        {
          errorCode: 500,
          status: "Failed",
          errorDescription:
            " - DataAccess Error: Error occurred while executing stored procedure. Cause: PROCEDURE classicmodels.new_procedure_invalid does not exist",
        },
        null,
        2
      ),
      endpointInfo: {
        basepath: "storedProcedureUnHappyPath/100",
      },
    },
  ],
};
